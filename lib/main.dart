...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget _buildTextComposer() {
    ...
    return Container(
      ...
      child: Row(
        children: [
          //Wrapping the TextField in a Flexible widget tells the Row to automatically
          // size the text field to use the remaining space that isn't used by the button.
          Flexible(
            child: TextField(
